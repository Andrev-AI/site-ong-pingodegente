...
import { FaHeart, FaHandHoldingHeart, FaUsers } from "react-icons/fa6";
...
function Home() {
    ...
    <div className='flex flex-col min-h-screen'>
     <section className='min-h-screen grid grid-cols-2'>
        <div className='flex flex-col bg-white'>
          ...
          <div className='mt-12 w-full flex items-center gap-3 ml-5'>
          ...
          <h1 className='text-5xl font-bold mt-8 leading-tight p-5'>
            Instituto Pingo de Gente - Onde o carinho e a esperança se encontram
          </h1>
          
          <div className='mt-12 ml-5'>
           <a href='doar'><button className='flex items-center justify-center px-6 py-4 rounded-lg bg-sky-500 text-xl text-white hover:bg-sky-600 transition-all duration-300 gap-2'>
  ...
  <h2 className='text-4xl font-bold mb-12 text-center' id="sobre-nos">Sobre Nós</h2>
  ...
  <div className='grid grid-cols-2 gap-8 mt-12'>
    <div className='bg-gradient-to-br from-blue-500 to-blue-600 p-8 rounded-2xl text-white flex items-center gap-8'>
    ...
    <div className='bg-gradient-to-br from-cyan-500 to-cyan-600 p-8 rounded-2xl text-white flex items-center gap-8'>
      <div className='flex-1'>
  ...
  {/* <div className='mt-16 text-center'>
    <button className='flex items-center justify-center px-8 py-4 rounded-lg bg-sky-500 text-xl text-white hover:bg-sky-600 transition-all duration-300 gap-2 mx-auto'>
  ...
  <div className='mt-12 text-center'>
    <a href='/doar'><button className='bg-sky-500 text-white px-8 py-4 rounded-lg hover:bg-sky-600 transition-all duration-300'>
        Doar
    </button></a>
  </div>
</section>
<section className='min-h-screen bg-white px-12 py-16'>
  ...
  <div className='grid grid-cols-2 gap-12 items-center max-w-6xl mx-auto'>
    <div>
      ...
      />
      <div className='mt-8'>
        <h3 className='text-2xl font-bold mb-4'>Instituto Pingo de Gente</h3>
  ...
  <div className='mt-12 text-center'>
    ...
    <a 
      ...
      className='inline-flex items-center bg-sky-500 text-white px-8 py-4 rounded-lg hover:bg-sky-600 transition-all duration-300'
    >
      Como Chegar
    </a>
  </div>
...
<footer className="bg-gray-900 text-white py-12">
  <div className="max-w-6xl mx-auto px-4">
    ...
    <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
      <p>&copy; {new Date().getFullYear()} Instituto Pingo de Gente. Todos os direitos reservados.</p>
    </div>
  </div>
</footer>
    </div>
